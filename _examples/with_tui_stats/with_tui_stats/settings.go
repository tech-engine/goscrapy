...
// Default: num of CPU * 8 (min 16)
const AUTOSCALER_MAX_WORKERS = ""

// Default: Concurrency / 2
const AUTOSCALER_MIN_WORKERS = ""

// Default: 1.0 (aggressive scaling)
const AUTOSCALER_SCALING_FACTOR = ""

// Default: runtime.NumCPU (min 4)
const ENGINE_RESULT_HANDLERS = ""
...
func init() {
	var settings = map[string]string{
		...
		"AUTOSCALER_SCALING_FACTOR":                    AUTOSCALER_SCALING_FACTOR,
		"ENGINE_RESULT_HANDLERS":                       ENGINE_RESULT_HANDLERS,
